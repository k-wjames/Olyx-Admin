...
import ke.co.ideagalore.olyxadmin.databinding.FragmentNewGasCylindersBinding;
import ke.co.ideagalore.olyxadmin.models.Refill;

public class NewGasCylindersFragment extends Fragment implements View.OnClickListener {

    FragmentNewGasCylindersBinding binding;
    ...
    public NewGasCylindersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNewGasCylindersBinding.inflate(inflater, container, false);
    ...
    private void showAddNewGasDialog() {
        ...
        add.setOnClickListener(view -> {
            if (validator.validateEditTextFields(getActivity(), productName, "Item name")
                ...
                saveNewGasItem(item, bPrice, mPrice, dialog);
            }
        });
    }


    private void saveNewGasItem(String item, int bPrice, int mPrice, Dialog dialog) {
